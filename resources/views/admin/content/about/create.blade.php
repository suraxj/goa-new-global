            ...
            <div class="col-xl-12">
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <form class="form" action="/admin/about/store" method="post" id="common_form_university" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="heading" value="{{$about->hading}}" placeholder="Course Name" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea class="form-control" name="sub_heading" placeholder="Short content for folder page" required></textarea>
                                            </div>
                                        </div>
