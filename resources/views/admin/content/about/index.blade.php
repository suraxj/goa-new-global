                ...
                <div class="card custom-card">
                    <div class="card-header justify-content-between">
                        ...
                        <div class="d-flex flex-wrap gap-1 project-list-main">
                            <a href="/admin/about/create" class="btn btn-primary me-2"><i class="ri-add-line me-1 fw-medium align-middle"></i>New Course</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="datatable-basic" class="table table-bordered text-nowrap w-100">
                                ...
                                <tbody>
                                    @foreach ($about ?? '' as $index => $course)
                                    <tr>
                                        <td>{{$index+1}} </td>
                                        <td>{{$course->heading}}</td>
                                        <td class="text-center"><img src="/{{$course->image}}" class="rounded" style="width:100px;"></td>
                                        <td>{{$course->sub_heading}}</td>
                                        
                                        
                                        </td>
                                      
                                        <td class="text-end">
                                            <a href="/admin/about/edit/{{$course->id}}" class="btn btn-sm btn-warning me-2"><i class="far fa-edit me-1"></i> Edit</a>
