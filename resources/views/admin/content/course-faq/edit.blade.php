<div class="modal-body">
    ...
    <div class="modal-body">
        <form action="/admin/courses/faq/update" method="post" id="updateFaq" enctype="multipart/form-data" novalidate>
            @csrf
            ...
            <div class="modal-body">
                <div class="row gy-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="content" id="content" cols="30" class="form-control ckContent" rows="4">{{$faq->answer}}</textarea>
                    </div>
