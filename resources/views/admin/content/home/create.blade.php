<div class="modal-body">
    ...
    <div class="modal-body">
        <form class="form row" action="/admin/homecontent/store" method="post" id="common_form_university" enctype="multipart/form-data">
            @csrf
            <div class="col-12 mb-3">
                <label class="form-label">Heading Name</label>
                <input type="text" class="form-control" name="heading" placeholder="Category Name" required>
            </div>
            <div class="col-12 mb-3">
                <label class="form-label">Sub Heading</label>
                <input type="text" class="form-control" name="sub_heading" placeholder="Category Name" required>
            </div>
