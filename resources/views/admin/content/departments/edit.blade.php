<div class="modal-body">
    ...
    <div class="modal-body">
        <form class="form row" action="/admin/courses/program/update" method="post" id="common_form_university" enctype="multipart/form-data">
            @csrf
            <div class="col-12 mb-3">
                <label class="form-label">Program Name</label>
                <input type="hidden" class="form-control" value="{{ $categories->id }}" name="id" />
                <input type="text" class="form-control" value="{{ $categories->name }}" name="department_name" placeholder="Choose the Right..." required />
            </div>
