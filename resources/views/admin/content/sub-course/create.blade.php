            ...
            <div class="col-xl-12">
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <form class="form" action="/admin/sub-courses/store" method="post" id="common_form_university" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="name" placeholder="Sub Course Name" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mb-3">
                                                <label class="form-label">Sub Course Image <small class="text-danger"> (Preferred size (WxH): 600x350) (less than 1 MB)</small></label>
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == '200') {
                        ...
                        setTimeout(() => {
                            window.location.href = '/admin/sub-courses';
                        }, 1500);
                    } else {
                        // $('#md_modal').modal('hide');
                        Toastify({
