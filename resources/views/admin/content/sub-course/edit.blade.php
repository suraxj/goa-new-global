            ...
            <div class="col-xl-12">
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <form class="form" action="/admin/sub-courses/update" method="post" id="common_form_university" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="form-select" name="category">
                                                    ...
                                                    <option value="{{$category->id}}" @if($category->id === $courses->course_id) selected @endif>{{$category->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
