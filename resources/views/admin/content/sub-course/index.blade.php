                ...
                <div class="card custom-card">
                    <div class="card-header justify-content-between">
                        ...
                        <div class="d-flex flex-wrap gap-1 project-list-main">
                            <a href="/admin/sub-courses/create" class="btn btn-primary me-2"><i class="ri-add-line me-1 fw-medium align-middle"></i>New Sub-Course</a>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="datatable-basic" class="table table-bordered text-nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="/admin/sub-courses/edit/{{$course->id}}" class="btn btn-sm btn-warning me-2"><i class="far fa-edit me-1"></i> Edit</a>
