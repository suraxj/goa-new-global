            ...
            <div class="col-xl-12">
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <form class="form" action="/admin/banner/store" method="post" id="common_form_university" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="tag" placeholder="banner image alt text">
                                            </div>
                                        </div>
