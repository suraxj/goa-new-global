<div class="modal-body">
    <div class="modal-header">
        <h6 class="modal-title" id="exampleModalLabel1">
            Edit University Category
        </h6>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    <div class="modal-body">
        <form action="/admin/university/faq/update" method="post" id="updateFaq" enctype="multipart/form-data" novalidate>
            @csrf
                ...
                <div class="row gy-3">
                    <div class="col-md-12">
                        ...
                        <select name="university_id" class="form-control">
                            ...
                            <option value="{{ $university->id}}" {{ $university->id == $faq->university_id ? 'selected' : '' }}>{{ $university->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-12">
