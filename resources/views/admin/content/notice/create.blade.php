<div class="modal-body">
    ...
    <div class="modal-body">
        <form action="/admin/home/notice/store" method="post" id="add_banner" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="modal-body">
                <div class="row gy-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="name" id="name" cols="15" class="form-control" rows="2" required></textarea>
                    </div>
                    <div class="col-md-12">
