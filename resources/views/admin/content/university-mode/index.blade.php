                ...
                <div class="card custom-card">
                    <div class="card-header justify-content-between">
                        ...
                        <div class="d-flex flex-wrap gap-1 project-list-main">
                            <button onclick="add();" class="btn btn-primary me-2"><i class="ri-add-line me-1 fw-medium align-middle"></i>New Mode</button>
                        </div>
                    </div>
                    <div class="card-body">
...
<script>
    function add() {
        $.ajax({
            url: '/admin/university/mode/create',
    ...
    function edit(id) {
        $.ajax({
            url: '/admin/university/mode/edit/' + id,
            success: function(data) {
                $('#md_modal_content').html(data);
                $('#md_modal').modal('show');
            }
    ...
    function destroy(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "/admin/university/mode/destroy",
                    type: 'POST',
                    data: {
                        "_token": "{{ csrf_token() }}",
                        "id": id
