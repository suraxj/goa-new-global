...
<section class="breadcumb-section py-5">
    <div class="container">
        <div class="row">
                        ...
                        <div class="course-card rounded-10 shadow card overflow-hidden">
                            ...
                            <div class="card-body">
                                <div class="card-front">
                                    ...
                                    <p class="h4 text-center fw-bold text-black fs-14 ">{{$course->name}}</p>
                                    <div class="d-flex justify-content-between border-top border-bottom">
                                        <p class="my-2">{{$course->sub_courses_count}} Specializations</p>
                                        <p class="my-2"><i class="fa-solid fa-building-columns me-2 warning"></i>{{$course->universities_count}}</p>
                                    </div>
                                </div>
                                <div class="card-back rounded-10 d-flex flex-column justify-content-between">
                                    <div>
                                        <p class="h4 text-center fw-bold text-black fs-14">{{$course->name}}</p>
                                        <div class="d-flex justify-content-between">
                                            <p class="badge mb-1 text-end bg-success text-white"><i class="fa fa-clock me-1"></i>{{$course->duration}}</p>
                                        ...
                                        <p class="text-justify">{{Str::limit($course->short_content,150)}}</p>
                                    </div>
