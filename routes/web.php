...
Route::view('/registration', 'front.content.registration')->name('registration');
Route::post('/add_registration', [LeadController::class, 'registration'])->name('add_registration');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('/admin/banner/update/{id}', [HomePageController::class, 'update'])->name('update_banners');
...
//notice
     Route::get('/admin/home/notice', [HomePageController::class, 'noticeIndex'])->name('noticeIndex');
    Route::get('/admin/home/notice/create', [HomePageController::class, 'noticeCreate'])->name('notice-create');
    Route::post('/admin/home/notice/store', [HomePageController::class, 'storeNotice'])->name('notice-store');
    Route::get('/admin/home/notice/edit/{id}', [HomePageController::class, 'editNotice'])->name('notice-edit');
    Route::post('/admin/home/notice/update', [HomePageController::class, 'updateNotice'])->name('notice-update');
    Route::post('/admin/home/notice/destroy', [HomePageController::class, 'destroyNotice'])->name('notice-destroy');
    ...
    Route::get('/admin/regs', [LeadController::class, 'regindex'])->name('regs-page');
    Route::get('/admin/regs/view/{id}', [LeadController::class, 'regsview'])->name('regs-view');
